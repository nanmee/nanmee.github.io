salesdesk_widget_load_script={};salesdesk_widget_load_script.options=salesdesk_widget_load_script.options||{};salesdesk_widget_load_script.options.debugMode=!1;var startDateTime=new Date();var salesdesk_widget_init_skype=!1;var has_r_chat=!1;var mobile_load_r_chat_first_time=!0;var first_add_message_listener=!0;var salesdesk_widget_timeout_list={show_default_btn_pulse_time:10000};if(typeof script_list=='undefined'){var script_list=new Array()}
script_list.push(document.currentScript.src.split("business_id=")[1])
...
function generateTimeSlot(){var slot=[];for(let i=1;i<49;i++){var start_time=(i-1)/2;if(start_time%1==0){start_time=start_time+":00"}else{start_time=Math.floor(start_time)
...
if(window.jQuery===undefined||(check_jquery_version<=check_jquery_lessthan_version)){var script_tag=document.createElement('script');script_tag.setAttribute("type","text/javascript");script_tag.setAttribute("src",widget_server_url+"/widget/jquery.min.js");var momentjs_script_tag=document.createElement('script');momentjs_script_tag.setAttribute('type','text/javascript');momentjs_script_tag.setAttribute('src',widget_server_url+'/widget/momentjs/moment.js');document.documentElement.appendChild(momentjs_script_tag)
...
var momentjs_script_tag=document.createElement('script');momentjs_script_tag.setAttribute('type','text/javascript');momentjs_script_tag.setAttribute('src',widget_server_url+'/widget/momentjs/moment.js');document.documentElement.appendChild(momentjs_script_tag)
...
var close_channel=!1;if(salesdesk_widget_options.display[channel_id].type==2&&salesdesk_widget_options.display[channel_id].schedule!='false'){var capital_timezone=salesdesk_widget_options.capital_timezone;var[tz_h,tz_m]=capital_timezone.split(':');var tz_opt='';if(tz_h.startsWith('+')||tz_h.startsWith('-')){tz_opt=tz_h[0];tz_h=tz_h.substr(1)}else{tz_opt='+'}
tz_h=moment(tz_h,'HH').hour();tz_m=moment(tz_m,'mm').minutes();var schedule=salesdesk_widget_options.display[channel_id].schedule;var current_date=new Date();var gmt_datetime=current_date.toUTCString().split(' ')[4];if(tz_opt=='-'){var gmt_time=moment(gmt_datetime,'HH:mm').subtract(tz_h,'hours')}else if(tz_opt=='+'){var gmt_time=moment(gmt_datetime,'HH:mm').add(tz_h,'hours')}else{return 0}
var today=moment(gmt_time).day();var time_slot=schedule[today-1];if(time_slot!==''){for(element of time_slot){var[start,end]=element.split(',');var time_start=moment(time_slot_resource[start-1],'HH:mm');var time_end=moment(time_slot_resource[end-1],'HH:mm');if((gmt_time.isSameOrAfter(time_start))&&(gmt_time.isBefore(time_end))){close_channel=!1;return 0}else{close_channel=!0}}}else{close_channel=!0}}else{close_channel=!1}
return close_channel}
function recheckChannelLength(){var channel_tracking_list=salesdesk_widget_options.business.use_tracking;var count=0;var count_channel=0;channel_tracking_list.forEach(element=>{if(!checkChannelTimeSchedule(element)){if(element!="callback"){count++}}});return count}
function checkChannelTrackingLength(){var channel_tracking_list=salesdesk_widget_options.business.use_tracking;var count=0;var count_channel=0;channel_tracking_list.forEach(element=>{if(!checkChannelTimeSchedule(element)){count++}});return count}
function salesdeskCreateWidget(cookie_text=null){try{if(salesdesk_widget_options.is_preview!==!0){if(!salesdesk_widget_load_script.isFirstLoad(salesdesk_widget_load_script.options)){return}
if(jQuerySalesDesk(".salesdesk-widget").length!=0){return}
salesdeskLoadJS();salesdeskLoadCSS()}
...
var salesdesk_widget_powered_by_text_style="";if(salesdesk_widget_options.position.name=="top-left"||salesdesk_widget_options.position.name=="top-center"||salesdesk_widget_options.position.name=="middle-left"||salesdesk_widget_options.position.name=="bottom-left"||salesdesk_widget_options.position.name=="bottom-center"){salesdesk_widget_powered_by_text_style='left: 65px;top: 15px;'}else if(salesdesk_widget_options.position.name=="top-right"||salesdesk_widget_options.position.name=="middle-right"||salesdesk_widget_options.position.name=="bottom-right"){salesdesk_widget_powered_by_text_style='right: 65px;top: 15px;'}
var salesdesk_widget_html='<div class="salesdesk-widget" style="display:none;"><div class="salesdesk-widget-'+salesdesk_widget_options.theme+'"><div class="salesdesk_widget_overlay"></div><div class="salesdesk_widget_click_page_overlay" id="salesdesk_widget_click_page_overlay"></div>';salesdesk_widget_html+='<div id="salesdesk_widget_button_group" class="float-btn-group salesdesk-widget-button-'+salesdesk_widget_options.position.name+'" style="'+salesdesk_widget_custom_style+'">';var salesdesk_custom_tooltip_background="";if(salesdesk_widget_options.button_menu.tooltip_background_color){var salesdesk_tooltip_text_color;var lum=salesdeskGetBrightness(salesdesk_widget_options.button_menu.tooltip_background_color);if(lum=='dark'){salesdesk_tooltip_text_color="#fff"}else{salesdesk_tooltip_text_color="#000"}
salesdesk_custom_tooltip_background=" background-color: "+salesdesk_widget_options.button_menu.tooltip_background_color+"; ";var pseudo_element_css='<style>.salesdesk-widget-button-text-top-right::after, .salesdesk-widget-button-text-style1-top-right::after , .salesdesk-widget-button-text-bottom-right::after , .salesdesk-widget-button-text-style1-bottom-right::after, .salesdesk-widget-button-text-middle-right::after , .salesdesk-widget-button-text-style1-middle-right::after  { border-left: 7px solid '+salesdesk_widget_options.button_menu.tooltip_background_color+' !important;} .salesdesk-widget-button-text-top-left::after, .salesdesk-widget-button-text-style1-top-left::after , .salesdesk-widget-button-text-top-center::after, .salesdesk-widget-button-text-style1-top-center::after , .salesdesk-widget-button-text-bottom-left::after , .salesdesk-widget-button-text-style1-bottom-left::after, .salesdesk-widget-button-text-bottom-center::after , .salesdesk-widget-button-text-style1-bottom-center::after, .salesdesk-widget-button-text-middle-left::after , .salesdesk-widget-button-text-style1-middle-left::after { border-right: 7px solid '+salesdesk_widget_options.button_menu.tooltip_background_color+' !important;}.salesdesk-widget-button-text {color: '+salesdesk_tooltip_text_color+' !important;}.powered_by_salesDesk {color: '+salesdesk_tooltip_text_color+' !important;}</style>';jQuerySalesDesk("head").append(pseudo_element_css)}
var call_back_html='';if(salesdeskCheckChannelId('callback')===!0){var close_callback=checkChannelTimeSchedule('callback');if(!close_callback){var option_call_back='';form_label.widget.callback.subject_custom_options
var option_call_back='<option value="">'+form_label.widget.callback.subject_please_select+'</option>';form_label.widget.callback.subject_custom_options.forEach(function(subject_option){var subject_option_text=subject_option.replace(/^\s+|\s+$/g,'').replace(/\s/g,'&nbsp;')
if(subject_option.length>27){option_call_back+='<option title="'+subject_option+'" value="'+subject_option+'">'+decodeHtml(subject_option_text).substring(0,26).concat('...')+'</option>'}else{option_call_back+='<option value="'+subject_option+'">'+decodeHtml(subject_option_text)+'</option>'}})
var callback_privacy_policy_consent_html;var callback_privacy_policy_consent_template=`
                <div class="callback-privacy-policy-consent">
                    <span>[privacy_policy_message]<a [target] href="[privacy_policy_url]">[privacy_policy_name_link]</a></span>
                </div>
                `;if(salesdesk_widget_options.business.use_callback_privacy_policy_consent){if(salesdesk_widget_options.business.use_custom_callback_privacy_policy_consent){var url=salesdesk_widget_options.business.custom_callback_privacy_policy_consent_link
...
call_back_html=`
                    <div class="salesdesk-call-back" id="salesdesk_display_call_back" style="${salesdesk_call_back_custom_style + salesdesk_widget_call_back_custom_style};">
                        <div class="salesdesk-call-back-header" style="color: ${salesdesk_widget_options.button_menu.background_color};">
                            ${form_label.widget['callback'].form_header}
                        </div>

                        <form id="salesdesk_call_back_form">
                            <div class="salesdesk-form-group">
                                <label class="salesdesk-form-label salesdesk-widget-form-label">${form_label.first_name }</label>
                                <div id="salesdesk_form_call_back_name_label" class="salesdesk-widget-form-label salesdesk-widget-form-error-container" style="display:none !important;">
                                    <div class="salesdesk-widget-form-error-message" id="salesdesk_form_call_back_name_error"></div>
                                </div>
                                <input id="salesdesk_form_call_back_name" maxlength="100" class="salesdesk-form-input salesdesk-call-back-name" type="text"  autocomplete="off">
                            </div>
                                
                            <div class="salesdesk-form-group">
                                <label class="salesdesk-form-label salesdesk-widget-form-label" for="salesdesk_form_call_back_phone">
                                    ${form_label.phone}
                                </label>
                                <div id="salesdesk_form_call_back_phone_label" class="salesdesk-widget-form-label salesdesk-widget-form-error-container" style="display:none !important;">
                                    <div class="salesdesk-widget-form-error-message" id="salesdesk_form_call_back_phone_error"></div>
                                </div>
                                <input id="salesdesk_form_call_back_phone" class="salesdesk-form-input salesdesk-call-back-tel" type="tel" placeholder="xxx-xxx-xxxx" autocomplete="off">
                            </div>

                            <div class="salesdesk-form-group">
                                <label class="salesdesk-form-label salesdesk-widget-form-label" for="salesdesk_form_call_back_subject">
                                    ${form_label.call_back_subject}
                                </label>
                                <div id="salesdesk_form_call_back_subject_label" class="salesdesk-widget-form-label salesdesk-widget-form-error-container" style="display:none !important;">
                                    <div class="salesdesk-widget-form-error-message" id="salesdesk_form_call_back_subject_error"></div>
                                </div>
                                <select title="" id="salesdesk_form_call_back_subject" class="salesdesk-form-input salesdesk-call-back-subject" autocomplete="off">
                                    ${option_call_back}
                                </select>
                            </div>
                                
                            <div class="salesdesk-form-container-btn">
                                <button type="submit" class="salesdesk-form-btn" style="background-color: ${salesdesk_widget_options.button_menu.background_color} !important;">
                                    ${form_label.widget['callback'].button_submit_name}
                                </button>
                            </div>
                        </form>

                        <div class="salesdesk-message-info"  id="callback_timeout_error" style="display: none; font-size: 11px; margin-top: 0; text-align: center !important;"> 
                            ${salsesdesk_channel_timeout_error_message[salesdesk_widget_options.language]}
                        </div>

                        <div id="salesdesk_call_back_message_container">
                            <div id="salesdesk_call_back_loading" class="salesdesk-message-info">
                                ${form_label.message_saving}
                            </div>
                            <div id="salesdesk_call_back_thank_you" class="salesdesk-message-info">
                                ${salesdeskNl2br(form_label.widget['callback'].thank_you_message)}
                            </div>
                        </div>
...
salesdesk_widget_popup+=salesdeskAllowNotificationPermissionPopupHtml();salesdesk_widget_popup+=salesdeskContactCodePopupHtml();salesdesk_widget_html+='</div></div></div></div>';if(salesdesk_widget_options.business.use_cookie_consent_banner){salesdesk_widget_html+=salesdeskCookieConsentBannerPopupHtml(salesdesk_widget_options.business.cookie_consent_banner_display_style);if(!salesdesk_widget_options.business.use_custom_cookie_consent_banner){var html=`
                <div class="cookie-policy-consent-wrapper" style="display: none;">
                    <div style="opacity: 1" id="salesdesk_widget_cookie_policy_en" class="salesdesk-widget-cookie-policy-en hide">
                        <div class="salesdesk-widget-icon-close-container salesdesk-form-btn-close" data-action="closeCookiePolicy();">
                            <div class="salesdesk-widget-icon-close"></div>
                        </div>

                        <div class="" id="salesdesk_widget_default_cookie_policy_content"></div>
                    </div>
                </div>`;salesdesk_widget_html+=html}}
var get_privacy_policy_text=!1;if((salesdesk_widget_options.business.use_contact_form_privacy_policy_consent&&!salesdesk_widget_options.business.use_custom_contact_form_privacy_policy_consent)||(salesdesk_widget_options.business.use_callback_privacy_policy_consent&&!salesdesk_widget_options.business.use_custom_callback_privacy_policy_consent)){var html=`
                <div class="form-policy-consent-wrapper" style="display: none;">
                    <div style="opacity: 1" id="sdwidget_privacy_policy_consent_container" class="sdwidget-privacy-policy-consent-container-hide">
                        <div class="salesdesk-widget-icon-close-container salesdesk-form-btn-close" data-action="closePrivacyPolicyConsentSdwForm();">
                            <div class="salesdesk-widget-icon-close"></div>
                        </div>

                        <div class="" id="sdwidget_privacy_policy_consent"></div>
                    </div>
                </div>
            `;salesdesk_widget_html+=html;get_privacy_policy_text=!0}
jQuerySalesDesk('body').append(salesdesk_widget_html);if(salesdesk_widget_options.business.use_cookie_consent_banner&&!salesdesk_widget_options.business.use_custom_cookie_consent_banner){jQuerySalesDesk.ajax({url:widget_server_url+"/widget/cookie_policy.js",dataType:"script",scriptCharset:"UTF-8",success:function(){jQuerySalesDesk("#salesdesk_widget_default_cookie_policy_content").html(cookie_policy[salesdesk_widget_options.language])}})}
if(get_privacy_policy_text){jQuerySalesDesk.ajax({url:widget_server_url+"/widget/sdwidget_form_privacy_policy.js",dataType:"script",scriptCharset:"UTF-8",success:function(){jQuerySalesDesk("#sdwidget_privacy_policy_consent").html(sdwidget_form_privacy_policy_consent[salesdesk_widget_options.language])}})}
if(salesdesk_widget_popup!=''){jQuerySalesDesk('body').append(salesdesk_widget_popup)}
...
function makeCookiesConsentBanner(){var[display_type,display_position]=salesdesk_widget_options.business.cookie_consent_banner_display_style.split('_');salesdeskOpenCookieConsentBannerPopup(salesdesk_widget_options.business.cookie_consent_banner_display_style);if((salesdeskGetCookie('cookie_consent_status')==null||salesdeskGetCookie('cookie_consent_status')!="accept")){if(display_type=='bar'){var height=document.querySelector('#salesdesk_widget_cookie_consent_banner_popup').offsetHeight
...
if(device_width>device_height&&salesdesk_device.is_mobile()){jQuerySalesDesk("#salesdesk_widget_button_group").css({"bottom":salesdesk_widget_button_default_position_bottom+"px",})}else{jQuerySalesDesk("#salesdesk_widget_button_group").css({"bottom":salesdesk_widget_options.position.custom.bottom+"px",})}
...
function salesdeskCookieConsentBannerAccept(){if(!salesdesk_widget_options.is_preview){salesdeskSetCookie('cookie_consent_status',"accept")}
...
function salesdeskCookieConsentBannerPopupHtml(display_style){var[display_type,display_position]=display_style.split('_');if((salesdeskGetCookie('cookie_consent_status')!==null&&salesdeskGetCookie('cookie_consent_status')=="accept")||salesdeskGetSessionStorage('cookie_consent_close')=="close"){return''}
var body_text_consent=``
if(display_type=='bar'){body_text_consent=`
        <div class="salesdesk-widget-cookie-consent-banner-popup-text" 
            style="color: ${salesdesk_widget_options.business.custom_cookie_consent_banner_text_color} !important;background-color: ${salesdesk_widget_options.business.custom_cookie_consent_banner_text_bg_color}!important;">
            
            ${salesdesk_widget_options.business.custom_cookie_consent_banner_text}

            <span>
                <a href="javascript:void(0);" class="salesdesk-form-btn-action" 
                    style="background-color: ${salesdesk_widget_options.business.custom_cookie_consent_banner_button_bg_color} !important; 
                            color: ${salesdesk_widget_options.business.custom_cookie_consent_banner_button_text_color} !important;" 
                    onclick="salesdeskCookieConsentBannerAccept()"> 
                ${salesdesk_widget_options.business.custom_cookie_consent_banner_button_text}</a>
            </span>
            
        </div>
        `}else{body_text_consent=`
        <div class="salesdesk-widget-cookie-consent-banner-popup-text" 
            style="color: ${salesdesk_widget_options.business.custom_cookie_consent_banner_text_color} !important;background-color: ${salesdesk_widget_options.business.custom_cookie_consent_banner_text_bg_color}!important;">
        ...
        <div style="display: block;" class="button-accept-cookie-consent">
            <span>
                <a href="javascript:void(0);" class="salesdesk-form-btn-action" 
                    style="background-color: ${salesdesk_widget_options.business.custom_cookie_consent_banner_button_bg_color} !important; 
                            color: ${salesdesk_widget_options.business.custom_cookie_consent_banner_button_text_color} !important;" 
        ...
        `}
var form_label=salesdeskGetFormLabel();var style=document.createElement('style');style.innerHTML=`
        #salesdesk_widget_cookie_consent_banner_popup a { 
            color: `+salesdesk_widget_options.business.custom_cookie_consent_banner_text_color+`; 
        }
    `;document.head.appendChild(style);var html=`
    <div class="salesdesk-widget-cookie-consent-banner-wrapper ${display_type}">
        <div class="control-consent-yaxis">
            <div class="control-consent-xaxis">
                <div id="salesdesk_widget_cookie_consent_banner_popup" 
                    style="background-color: ${salesdesk_widget_options.business.custom_cookie_consent_banner_text_bg_color};" 
                    class="salesdesk-widget-cookie-consent-banner-popup-container ${display_type} ${display_position} hide">
...
function salesdeskCloseCookieConsentBannerPopup(){jQuerySalesDesk("#salesdesk_widget_cookie_consent_banner_popup").removeClass("open").addClass("hide");var[display_type,display_position]=salesdesk_widget_options.business.cookie_consent_banner_display_style.split('_');if(display_type=='bar'&&display_position=='bottom'){jQuerySalesDesk("#salesdesk_widget_button_group").css("bottom",default_widget_bottom+"px");jQuerySalesDesk("#salesdesk_display_call_back").css("bottom",(default_callback_bottom)+"px")}else if(display_type=='bar'&&display_position=='top'){jQuerySalesDesk("#salesdesk_widget_button_group").css("top",default_widget_top+"px");jQuerySalesDesk("#salesdesk_display_call_back").css("top",(default_callback_top)+"px")}}
...
if(salesdesk_widget_options.business.use_contact_form_privacy_policy_consent){if(salesdesk_widget_options.business.use_custom_contact_form_privacy_policy_consent){var url=salesdesk_widget_options.business.custom_contact_form_privacy_policy_consent_text_link
var checkUrl=/^(http(s)?):\/\//.test(url);if(!checkUrl){url='http://'+url}
...
html+='</div>';html+='<div class="salesdesk-widget-contact-popup-footer">';html+='<input type="submit" value="'+form_label.button_submit+'" class="salesdesk-form-submit">';html+=privacy_policy_consent_html;html+='</div>';html+='<form>';html+='</div>';return html}
...
if(custom_option.button_menu.hasOwnProperty('tooltip_background_color')){salesdesk_widget_options.button_menu.tooltip_background_color=custom_option.button_menu.tooltip_background_color}}
...
var css=[widget_server_url+"/widget/css/widget"+dot_min+".css?v="+salesdesk_widget_options.version];for(var i=0;i<css.length;i++){jQuerySalesDesk("<link>",{rel:"stylesheet",type:"text/css",href:css[i]}).appendTo('head')}}catch(err){}}
...
return null}
function salesdeskDeleteCookie(name,path,domain){if(GetCookie(name)){document.cookie=name+"="+((path)?"; path="+path:"")+((domain)?"; domain="+domain:"")+"; expires=Thu, 01-Jan-70 00:00:01 GMT"}}
...
function gotoWidgetLandingPage(){window.open(widget_server_url+"/api/redirect/poweredby/"+salesdesk_widget_options.business.business_id)}
