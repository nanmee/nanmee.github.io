                            ...
                            if(res) { 
                                ...
                                if(typeof res.carttotal != 'undefined') {                                   
                                    if(res.carttotal!=0){ 
                                       ...
                                       document.getElementById("mini-cart-total").innerHTML =parseFloat(res.cartcount);  
                                        document.getElementById("carttotalamount").innerHTML ='฿'+parseFloat(res.cartsubtotal).toFixed(2).toString().replace(/(\d)(?=(\d\d\d)+(?!\d))/g, "$1,"); 
                                 ...
                                 if(typeof res.cartcount != 'undefined') {                             
                                    if(parseInt(res.cartcount)==0){
                                        document.getElementById("carttotalamount").innerHTML = "฿0.00"; 
                                        document.getElementById("header-text").innerHTML = "ไม่มีสินค้าในรถเข็นที่จะแสดง";   
                                    }else{ 

                                        document.getElementById("header-text").innerHTML = "แสดงสินค้า "+ parseInt(res.cartcount) +" จาก " +parseInt(res.cartcount)+" ชิ้น";     
                                    }                                    
                                  }                       
                                   ...
                                   if( currentUrl.search('/checkout/') != -1 ) {                           
                                     if(typeof res.cartsubtotal != 'undefined') {  
                                           ...
                                           if(res.carttotal!=0){                            
                                                ...
                                                document.getElementById("grand-total").innerHTML ='$'+parseFloat(res.carttotal).toFixed(2).toString().replace(/(\d)(?=(\d\d\d)+(?!\d))/g, "$1,");
                                            }else{
                                ...
                                if(res.configurable_options_block) {
                                    ...
                                    if(res.r == 'success') {
                                        if(res.message) {                                              
                                           ...
                                           _this.showSuccess('เพิ่มสินค้าในรถเข็นแล้ว.');
                                        }
                        ...
                        onSuccess    : function(response) {  
                            ...
                            try{
                                ...
                                if(res) {   
                                     ...
                                     if(typeof res.carttotal != 'undefined') {                             
                                       if(res.carttotal!=0){                            
                                            document.getElementById("mini-cart-total").innerHTML =parseFloat(res.cartcount);                                              document.getElementById("carttotalamount").innerHTML ='฿'+parseFloat(res.cartsubtotal).toFixed(2); 
                                            $('minicartfooterid').show();                     
                                        }else{
                                            document.getElementById("mini-cart-total").innerHTML ='0'; 
                                            document.getElementById("carttotalamount").innerHTML ='฿ 0.00'; 
